...
## ---- message=TRUE, echo=TRUE, fig.width = 5, fig.cap="**Figure 1**. d_1 scores along with 95% confidence interval."----
...
## ---- message=FALSE, echo=TRUE, fig.width=5, fig.cap="**Figure 2**. d_1 scores along with 95% confidence interval."----
