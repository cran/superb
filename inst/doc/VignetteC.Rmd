...
```{r, message=FALSE, echo=TRUE, fig.width = 5, fig.cap="**Figure 1**. Anscombe-transformed scores as a function of group."}
...
```{r, message=FALSE, echo=TRUE, fig.width = 5, fig.cap="**Figure 2**. Proportion as a function of group."}
superbPlot(dta, 
    BSFactors = "group",
    variables = "scores",
    statistic = "prop", 
