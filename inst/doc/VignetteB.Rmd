...
```{r, message=FALSE, echo=TRUE, fig.width = 5, fig.cap="**Figure 1**. Mean response times to say **Word** or **Non-word**."}
superbPlot(Fulldta,
    WSFactors = c("Nletters(4)","Nuppercase(4)"),
...
```{r, message=FALSE, echo=TRUE, fig.width = 5, fig.cap="**Figure 2**. Mean response times to say **Word** or **Non-word**."}
superbPlot(dta,
    WSFactors = c("Nletters(4)","Nuppercase(4)"),
