...
must be contained within a ``data.frame`` with named columns. It is easy to go 
from **wide format** to **long format**, with, e.g.,
...
Note that missing data are not handled by ``superb``. The cells with NA must be 
