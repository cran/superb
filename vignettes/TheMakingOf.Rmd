...
```{r, message=FALSE, echo=TRUE, eval=FALSE, fig.width=9, fig.height=4, fig.cap="**Figure 1**. The complete Figure 1."}
...
```{r, message=FALSE, echo=TRUE, eval=FALSE, fig.width=9, fig.height=4, fig.cap="**Figure 2**. The complete Figure 2."}
...
```{r, message=FALSE, echo=TRUE, eval=FALSE, fig.width=8, fig.height=4, fig.cap="**Figure 3**. The complete Figure 3."}
...
```{r, message=FALSE, echo=TRUE, eval=FALSE, fig.width=9, fig.height=4, fig.cap="**Figure 4**. The complete Figure 4."}
