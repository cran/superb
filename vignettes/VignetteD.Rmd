...
BEGIN PROGRAM R.
    ...
    if(!require(superb)) 
        install.packages("superb", type="binary", repos = "http://cran.us.r-project.org")
...
```{r fig2, echo=FALSE, fig.cap="**Figure 2: Syntax to generate a plot**", fig.width = 5, fig.height = 5}
library(png)
